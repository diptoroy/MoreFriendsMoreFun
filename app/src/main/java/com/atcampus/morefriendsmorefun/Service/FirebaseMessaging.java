...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendNormalNotification(RemoteMessage remoteMessage) {
        ...
        bundle.putString("pUid",user);
        intent.putExtras(bundle);
        PendingIntent pIntent = PendingIntent.getActivity(this,i,intent,PendingIntent.FLAG_ONE_SHOT);

        Uri soundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_RINGTONE);
        VersionNotification versionNotification = new VersionNotification(this);
        Notification.Builder builder = versionNotification.getNotification(title,body,pIntent,soundUri,icon);
...
//                .setContentIntent(pIntent);
        ...
        versionNotification.getManager().notify(j, builder.build());
